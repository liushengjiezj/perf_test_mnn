...
CPUBackend::CPUBackend(int numberThread, BackendConfig::MemoryMode memory, BackendConfig::PowerMode power, size_t flags)
    ...
    switch (power) {
        ...
        case BackendConfig::Power_High:
            ...
            break;
        case BackendConfig::Power_All:
            MNNSetCPUThreadsMode(MNN_CPU_MODE_POWER_FRI);
            break;
        // only used to set little kernel of honor v20 to cpu 0,1,2,3
        case BackendConfig::Power_honor:
            MNNSetCPUThreadsMode(MNN_CPU_MODE_POWER_HONOR);
            break;
        default:
            break;
    }
